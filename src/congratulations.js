function congratulations(config) {
  ...
  console.info('\n  Get started by:');
  console.info('    1. "cd ' + project.name.snakeCase + '" into your new project\'s directory');
  ...
  console.info('      * "npm test"  - will use mocha to run all "' + project.name.snakeCase + '/test" files');
  console.info('');
}
